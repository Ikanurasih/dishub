...
$strsql="INSERT INTO bar_izin_bongkar_muat (tanggal, jenis_kend_pickup, jenis_kend_truk, jenis_kend_tgt, jml_kend_1, pend_pickup,pend_truk,pend_tgt, tonase_pickup, tonase_truk, tonase_tgt, jml_kend_2, jb_bbm, jb_sembako,jb_kelontong,jb_bangunan,jb_hewan,jb_paket,jb_lain,jml_barang,ket, tgl_entri) 
VALUES ('$tanggal','$jenis_kend_pickup','$jenis_kend_truk','$jenis_kend_tgt','$jml_kend_1','$pend_pickup','$pend_truk','$pend_tgt','$tonase_pickup','$tonase_truk','$tonase_tgt','$jml_kend_2','$jb_bbm','$jb_sembako','$jb_kelontong','$jb_bangunan','$jb_hewan','$jb_paket','$jb_lain','$jml_barang','$ket','$sekarang')"; //echo $strsql;

if (empty($tanggal))
{
echo "<script>alert('Tanggal  Tidak Boleh Kosong'); document.location.href='index.php?act=add&do=data.izin_bongkar&tanggal=$tanggal&jenis_kend_pickup=$jenis_kend_pickup&jenis_kend_truk=$jenis_kend_truk&jenis_kend_tgt=$jenis_kend_tgt&jml_kend_1=$jml_kend_1&pend_pickup=$pend_pickup&tonase_truk=$tonase_truk&tonase_tgt=$tonase_tgt&jml_kend_2=$jml_kend_2&jb_bbm=$jb_bbm&jb_sembako=$jb_sembako&jb_kelontong=$jb_kelontong&jb_bangunan=$jb_bangunan&jb_hewan=$jb_hewan&jb_paket=$jb_paket&jb_lain=$jb_lain&jml_barang=$jml_barang&ket=$ket&pend_truk=$pend_truk&pend_tgt=$pend_tgt&tonase_pickup=$tonase_pickup';</script>\n";
exit();
}
else
{
