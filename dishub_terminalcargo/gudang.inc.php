...
<table width="941" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="880"><strong><font color="#000000" size="4" face="Arial, Helvetica, sans-serif">Data Sewa Gudang </font></strong></td>
  </tr>
</table>
<?php
if ($act=="cetak")
...
<legend> Cetak Laporan Data Sewa Gudang: </legend>
<table class="tdtitle_black">
<form method="post" action="lap_gudang.php" target="_blank">
...
<?php
  ...
  <form name="frmadd" method="post" action="insert_gudang.php">
  <!--DWLayoutTable-->
    <tr class="tdtitle_white"> 
	<td height="25" colspan="3" background="images/bgcell.gif"><div align="center">Tambah Data Sewa Gudang</div></td>
  </tr>
...
&nbsp; <input type="text" name="keterangan" id="keterangan" size="45" value="<?php echo $keterangan; ?>" class="inputbox" /></td>
    ...
    <tr valign="middle" class="tdtitle_black2"> 
      <td height="40" colspan="3" bgcolor="efefef">&nbsp; <a href="index.php?do=data.gudang"><img src="images/kembali2.gif" alt="klik disini untuk Kembali ke Halaman Sebelumnya" width="78" height="23" border="0"></a> 
        &nbsp;&nbsp; 
  ...
  ?>
 <table width="442" border="1" cellpadding="0" cellspacing="0">
  <form name="frmadd" method="post" action="update_gudang.php">
  <input type="hidden" name="id" value="<?php echo $id; ?>" /> 
  <!--DWLayoutTable-->
    <tr class="tdtitle_white"> 
	<td height="25" colspan="3" background="images/bgcell.gif"><div align="center">Edit Data Sewa Gudang</div></td>
  </tr>
  <tr class="tdtitle_black">
    <td width="121" height="30" valign="middle" bgcolor="#dddddd">&nbsp;Nama</td>
    <td width="10" valign="middle" bgcolor="efefef"> 
...
&nbsp;    	<select name="luas" class="inputbox" onChange="showme()">
			...
			</select><input type ="text" name="input1" style=" position:relative;visibility:hidden;" value="<?php echo $row[luas]; ?>" class="inputbox"> 	
	</td>
  </tr>
      <tr class="tdtitle_black">
    <td width="121" height="30" valign="middle" bgcolor="#dddddd">&nbsp;Nomor SK</td>
...
&nbsp; <input type="text" name="keterangan" id="keterangan" size="45" value="<?php echo $row[keterangan]; ?>" class="inputbox" /></td>
  ...
  <tr>
    <td width="773"><a href="?act=add&do=data.gudang"><img src="images/add.png" width="30" height="30" border="0" title="klik disini untuk Tambah Data Legalitas Baru"></a><a href="javascript:document.location.reload();"><img src="images/refresh.png" title="klik disini untuk Refresh" width="30" height="30" hspace="20" border="0"></a></td>
  </tr>
  <tr class="tdtitle_black">
  <td>
    	<fieldset>
    ...
    <option value="no_gudang" <?php if ($kategori=="no_gudang") echo "selected"; ?>>No. Gudang</option>
    ...
    <option value="no_gudang" <?php if ($kategori2=="no_gudang") echo "selected"; ?>>No. Gudang</option>
    ...
    <form method="post" action="index.php?do=data.gudang">
                ...
                <tr>
                	<td colspan="5"><input type="button" value=" Cari " class="inputbox" onClick=" document.location.href='index.php?do=data.gudang&kategori='+document.getElementById('kategori').value+'&key='+document.getElementById('key').value+'&kategori2='+document.getElementById('kategori2').value+'&key2='+document.getElementById('key2').value; "></td>
                </tr>
            </table>
        </fieldset>
    </td>
	<td width="246"></td>
	<td width="281" valign="bottom"><div align="right"><a href="excel_gudang.php?do=data.apill&kategori=<?php echo $kategori; ?>&key=<?php echo $key; ?>&kategori2=<?php echo $kategori2; ?>&key2=<?php echo $key2; ?>&act=excel"><img src="images/excel.jpg" width="68" height="23" border="0"></a>&nbsp;&nbsp;<a href="index.php?do=data.gudang&act=cetak&kategori=<?php echo $kategori; ?>&key=<?php echo $key; ?>&kategori2=<?php echo $kategori2; ?>&key2=<?php echo $key2; ?>"><img src="images/cetak.gif" title="Klik disini untuk Cetak Laporan" border="0"></a></div></td>
 ...
 <table border="1" cellspacing="0" cellpadding="1" width="1320">
  <tr class="tdtitle_white">
    ...
    <td   width="100" background="images/bgcell.gif" height="25" align="center">Nama</td> 
    <td   width="200" background="images/bgcell.gif" height="25" align="center">Alamat</td>                                        
    <td   width="100" background="images/bgcell.gif" height="25" align="center">Jenis Usaha</td>                                        
    <td   width="100" background="images/bgcell.gif" height="25" align="center">No. Gudang</td>                                        
    <td   width="110" background="images/bgcell.gif" height="25" align="center">Luas Gudang </td>              
  ...
  <?php
	...
	{  $strsql="select *, to_days(masa_berlaku)-to_days(curdate()) as jatuh_tempo from cargo_wc where status='3' and nama like '%$key%' order by id desc";	}
	elseif ($kategori=="alamat" and !empty($key))
	{  $strsql="select *, to_days(masa_berlaku)-to_days(curdate()) as jatuh_tempo from cargo_wc where status='3' and alamat like '%$key%' order by id desc";	}
	elseif ($kategori=="jenis_usaha" and !empty($key))
	{  $strsql="select *, to_days(masa_berlaku)-to_days(curdate()) as jatuh_tempo from cargo_wc where status='3' and jenis_usaha like '%$key%' order by id desc";	}
	elseif ($kategori=="no_gudang" and !empty($key))
	{  $strsql="select *, to_days(masa_berlaku)-to_days(curdate()) as jatuh_tempo from cargo_wc where status='3' and no_gudang like '%$key%' order by id desc";	}
	elseif ($kategori=="luas" and !empty($key))
	{  $strsql="select *, to_days(masa_berlaku)-to_days(curdate()) as jatuh_tempo from cargo_wc where status='3' and luas like '%$key%' order by id desc";	}
	elseif ($kategori=="nomor_sk" and !empty($key))
	{  $strsql="select *, to_days(masa_berlaku)-to_days(curdate()) as jatuh_tempo from cargo_wc where status='3' and nomor_sk like '%$key%' order by id desc";	}
	elseif ($kategori=="tanggal" and !empty($key))
	{  $strsql="select *, to_days(masa_berlaku)-to_days(curdate()) as jatuh_tempo from cargo_wc where status='3' and tanggal_sk='$key' order by id desc";	}
	elseif ($kategori=="berlaku" and !empty($key))
	{  $strsql="select *, to_days(masa_berlaku)-to_days(curdate()) as jatuh_tempo from cargo_wc where status='3' and masa_berlaku='$key' order by id desc";	}*/
	...
	{  $strsql="select *, to_days(masa_berlaku)-to_days(curdate()) as jatuh_tempo from cargo_wc where status='3' order by id desc"; 	}
  $hasil=mysql_query($strsql);
