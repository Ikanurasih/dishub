...
<table width="500" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td><strong><font color="#000000" size="4" face="Arial, Helvetica, sans-serif">Data Sewa Jasa Kamar Mandi / WC </font></strong></td>
  </tr>
</table>
<?php
if ($act=="cetak")
...
<legend> Cetak Laporan Data Sewa Jasa Kamar Mandi / WC: </legend>
<table class="tdtitle_black">
<form method="post" action="lap_wc.php" target="_blank">
...
<tr>
  <td colspan="3"><a href="index.php?do=data.sewa_wc"><img src="images/batal.gif" title="Klik disini untuk Batal" width="70" height="23" border="0"></a>&nbsp;&nbsp;
...
<table width="442" border="1" cellpadding="0" cellspacing="0">
  <form name="frm_add_user" method="post" action="insert_wc.php">
  <!--DWLayoutTable-->
    <tr class="tdtitle_white"> 
	<td height="25" colspan="3" background="images/bgcell.gif"><div align="center">Tambah Data Sewa Jasa Kamar Mandi / WC </div></td>
  </tr>
...
&nbsp; <input type="text" name="keterangan" size="45" value="<?php echo $keterangan; ?>" class="inputbox"   /></td>
    ...
    <tr valign="middle" class="tdtitle_black2"> 
      <td height="40" colspan="3" bgcolor="efefef">&nbsp; <a href="index.php?do=data.sewa_wc"><img src="images/kembali2.gif" alt="klik disini untuk Kembali ke Halaman Sebelumnya" width="78" height="23" border="0"></a> 
        &nbsp;&nbsp; 
...
elseif ($act=="edit")
{
  $strsql="select * from cargo_wc where id='$id'";
  $hasil=mysql_query($strsql);
  $row=mysql_fetch_array($hasil);
?>
<table width="442" border="1" cellpadding="0" cellspacing="0">
  <form name="frm_add_user" method="post" action="update_wc.php">
  <input type="hidden" name="id" value="<?php echo $id; ?>">
  <!--DWLayoutTable-->
    <tr class="tdtitle_white"> 
	<td height="25" colspan="3" background="images/bgcell.gif"><div align="center">Edit Data Sewa Jasa Kamar Mandi / WC </div></td>
  </tr>
  <tr class="tdtitle_black">
    <td width="121" height="30" valign="middle" bgcolor="#dddddd">&nbsp;Nama</td>
    <td width="10" valign="middle" bgcolor="efefef"> 
    ...
    <td width="303" valign="middle" bgcolor="efefef"> 
&nbsp;
<input type="text" name="nama" size="25" value="<?php echo $row[nama]; ?>" class="inputbox"   /></td>
  </tr>
   <tr class="tdtitle_black">
    <td width="121" height="30" valign="middle" bgcolor="#dddddd">&nbsp;Alamat</td>
    <td width="10" valign="middle" bgcolor="efefef"> 
...
<input type="text" name="nomor_sk" size="15" value="<?php echo $row[nomor_sk]; ?>" class="inputbox"   /></td>
    ...
    <td width="303" valign="middle" bgcolor="efefef"> 
&nbsp;
<input type="text" name="tgl_sk" id="tgl_sk" size="10" value="<?php if ($row[tanggal_sk]=="0000-00-00") {	echo ""; }else{ echo $row[tanggal_sk];} ?>" class="inputbox" readonly />
<img src="popupcal/images/calendar.gif" width="24" height="12" onClick="displayCalendar(document.getElementById('tgl_sk'),'yyyy-mm-dd',this)" style="cursor:pointer" /></td>
  </tr>
      <tr class="tdtitle_black">
    <td width="121" height="30" valign="middle" bgcolor="#dddddd">&nbsp;Masa Berlaku Sewa </td>
    <td width="10" valign="middle" bgcolor="efefef"> 
    ...
    <td width="303" valign="middle" bgcolor="efefef"> 
&nbsp;
<input type="text" name="masa_berlaku" id="masa_berlaku" size="10" value="<?php if ($row[masa_berlaku]=="0000-00-00") {	echo ""; }else{ echo $row[masa_berlaku];} ?>" class="inputbox" readonly />
...
{
?>
<table width="1120" border="0" cellpadding="2" cellspacing="2">
  <tr>
    <td width="366"><a href="?act=add&do=data.sewa_wc"><img src="images/add.png" width="30" height="30" border="0" title="klik disini untuk Tambah Data Legalitas Baru"></a><a href="javascript:document.location.reload();"><img src="images/refresh.png" title="klik disini untuk Refresh" width="30" height="30" hspace="20" border="0"></a></td>
  </tr>
  <tr class="tdtitle_black">
  	<td>
    	<fieldset>
            ...
            <table>
            	<tr class="text">
                	<td>Pencarian 1</td>
                    <td>:</td>
                    <form method="post" action="index.php?do=data.sewa_wc">
                    <input type="hidden" name="kategori2" value="<?php echo $kategori2; ?>">
	...
	<option value="keterangan" <?php if ($kategori=="keterangan") echo "selected"; ?>>Keterangan</option>
	</select></td>
    </form>
    <form method="post" action="index.php?do=data.sewa_wc">
    				<td> 
	...
	<option value="keterangan" <?php if ($kategori2=="keterangan") echo "selected"; ?>>Keterangan</option>
	</select></td>
    </form>
    <form method="post" action="index.php?do=data.sewa_wc">
    				<td> 
                ...
                <tr>
                	<td colspan="5"><input type="button" value=" Cari " class="inputbox" onClick=" document.location.href='index.php?do=data.sewa_wc&kategori='+document.getElementById('kategori').value+'&key='+document.getElementById('key').value+'&kategori2='+document.getElementById('kategori2').value+'&key2='+document.getElementById('key2').value; "></td>
                </tr>
            </table>
        </fieldset>
    </td>
	<td width="0"></td>
	<td width="281" valign="bottom"><div align="right"><a href="excel_wc.php?do=data.apill&kategori=<?php echo $kategori; ?>&key=<?php echo $key; ?>&kategori2=<?php echo $kategori2; ?>&key2=<?php echo $key2; ?>&act=excel"><img src="images/excel.jpg" width="68" height="23" border="0"></a>&nbsp;&nbsp;<a href="index.php?do=data.sewa_wc&act=cetak&kategori=<?php echo $kategori; ?>&key=<?php echo $key; ?>&kategori2=<?php echo $kategori2; ?>&key2=<?php echo $key2; ?>"><img src="images/cetak.gif" title="Klik disini untuk Cetak Laporan" border="0"></a></div></td>
	
  </tr>
</table>
 <table border="1" cellspacing="0" cellpadding="1" width="1120">
  <tr class="tdtitle_white">
    ...
    <td   width="100" background="images/bgcell.gif" height="25" align="center">Tanggal SK </td>                                  
    <td   width="100" background="images/bgcell.gif" height="25" align="center">Masa Berlaku Sewa </td>                                  
    <td   width="200" background="images/bgcell.gif" height="25" align="center">Keterangan</td>    
   ...
   <?php
	if(!empty($key) || !empty($key2)){
		if(!empty($kategori)){
			if(!empty($kategori2)){
				$strsql="select *, to_days(masa_berlaku)-to_days(curdate()) as jatuh_tempo from cargo_wc where status='1' and $kategori like '%$key%' and $kategori2 like '%$key2%' order by id desc";
			}else{
				$strsql="select *, to_days(masa_berlaku)-to_days(curdate()) as jatuh_tempo from cargo_wc where status='1' and $kategori like '$key' order by id desc";
			}
		}else{
			if(!empty($kategori2)){
				$strsql="select *, to_days(masa_berlaku)-to_days(curdate()) as jatuh_tempo from cargo_wc where status='1' and $kategori2 like '%$key2%' order by id desc";
			}
		}
	}
	else
	{  $strsql="select *, to_days(masa_berlaku)-to_days(curdate()) as jatuh_tempo from cargo_wc where status='1' order by id desc"; 	}
  $hasil=mysql_query($strsql);
  ...
  ?>">
  <td align="center" width="50"><a href="?do=data.sewa_wc&act=edit&id=<?php echo $row[id]; ?>"><img src="images/icon_edit.gif" border="0" title="Klik disini untuk Edit Data"></a></td>
    <td align="center" width="20"><a href="?do=data.sewa_wc&act=del&id=<?php echo $row[id]; ?>" onClick="return confirmdelete('Data ini');"><img src="images/icon_delete.gif" title="Klik disini untuk Hapus Data" border="0"></a></td> 
