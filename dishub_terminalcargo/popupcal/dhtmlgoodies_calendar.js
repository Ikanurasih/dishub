...
*/
var languageCode = 'in';	// Possible values: 	en,ge,no
...
switch(languageCode){
	...
	case "in":
		...
		var monthArrayShort = ['Jan','Feb','Mar','Apr','Mei','Jun','Jul','Aug','Sep','Oct','Nov','Dec'];
		var dayArray = ['Sen','Sel','Rab','Kam','Jum','Sab','Min'];
		var weekString = '#';
		var todayString = 'Hari ini';
		break;
...
function highlightSelect()
{
	if(this.className=='selectBox'){
		...
		this.getElementsByTagName('IMG')[0].src = 'popupcal/images/down_over.gif';
	}else{
		this.className = 'selectBox';	
		this.getElementsByTagName('IMG')[0].src = 'popupcal/images/down.gif';			
	}
...
function highlightArrow()
{
	if(this.src.indexOf('over')>=0){
		if(this.src.indexOf('left')>=0)this.src = 'popupcal/images/left.gif';	
		if(this.src.indexOf('right')>=0)this.src = 'popupcal/images/right.gif';				
	}else{
		if(this.src.indexOf('left')>=0)this.src = 'popupcal/images/left_over.gif';	
		if(this.src.indexOf('right')>=0)this.src = 'popupcal/images/right_over.gif';	
	}
}
...
{
	if(this.src.indexOf('over')>=0){
		this.src = 'popupcal/images/close.gif';
	}else{
		this.src = 'popupcal/images/close_over.gif';	
	}	
...
function writeTopBar()
{
	...
	img.src = 'popupcal/images/left.gif';
	...
	var img = document.createElement('IMG');
	img.src = 'popupcal/images/right.gif';
	img.onclick = switchMonth;
	img.onmouseover = highlightArrow;
	img.onmouseout = highlightArrow;
	...
	var img = document.createElement('IMG');
	img.src = 'popupcal/images/down.gif';
	...
	var img = document.createElement('IMG');
	img.src = 'popupcal/images/close.gif';
