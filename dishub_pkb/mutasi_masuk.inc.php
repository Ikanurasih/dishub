...
<table width="500" cellspacing="0" cellpadding="0">
  <tr> 
    ...
    <td><strong><font color="#000000" size="4" face="Arial, Helvetica, sans-serif">Data Mutasi Kendaraan </font></strong></td>
  </tr>
</table>
<?php
if ($act=="cetak")
...
<legend> Cetak Laporan Data Mutasi Masuk: </legend>
<table class="tdtitle_black">
<form method="post" action="lap_mutasi_masuk.php" target="_blank">
...
<tr>
  <td colspan="3"><a href="index.php?do=data.mutasi_masuk"><img src="images/batal.gif" title="Klik disini untuk Batal" width="70" height="23" border="0"></a>&nbsp;&nbsp;
...
<?php
  ...
  <form method="post" action="insert_mutasi_masuk.php" name="frmadd">
  <!--DWLayoutTable-->
    <tr class="tdtitle_white"> 
	<td height="25" colspan="3" background="images/bgcell.gif"><div align="center">Tambah Data Mutasi Masuk</div></td>
  </tr>
...
&nbsp;    
    ...
    <tr valign="middle" class="tdtitle_black2"> 
      <td height="40" colspan="3" bgcolor="efefef">&nbsp; <a href="index.php?do=data.mutasi_masuk"><img src="images/kembali2.gif" alt="klik disini untuk Kembali ke Halaman Sebelumnya" width="78" height="23" border="0"></a> 
        &nbsp;&nbsp; 
  ...
  ?>
  <table width="442" border="1" cellpadding="0" cellspacing="0">
  <form method="post" action="update_mutasi_masuk.php" name="frmadd">
  <input type="hidden" name="id" value="<?php echo $id; ?>" />
  <!--DWLayoutTable-->
    <tr class="tdtitle_white"> 
	<td height="25" colspan="3" background="images/bgcell.gif"><div align="center">Edit Data Mutasi Masuk</div></td>
  </tr>
  <tr class="tdtitle_black">
...
&nbsp; <select name="kategori" class="inputbox" onChange="showme()">
	...
	<?php
	}elseif($row[kategori]=="Dump Truk" and $row[kategori]=="Tanki" and $row[kategori]=="Bak Terbuka" and $row[kategori]=="Bak Tertutup/Box")
	{
	?>
  ...
  <tr class="tdtitle_black"> 
	  ...
	  <td valign="middle" bgcolor="efefef">&nbsp;
		...
		<?php
			...
			{
			?>
			<input type ="text" name="input_bahan_bakar" value="<?php echo $row[bahan_bakar]; ?>" class="inputbox" style="position:relative;visibility:none;" >
			<?php
			}
		?>
	</td>
    	...
    	<fieldset>
            ...
            <table>
            	<tr class="text">
                	<td>Pencarian 1</td>
                    <td>:</td>
                    <form method="post" action="index.php?do=data.mutasi_masuk">
                    <input type="hidden" name="kategori2" value="<?php echo $kategori2; ?>">
...
<option value="tgl_mutasi" <?php if ($kategori=="tgl_mutasi") echo "selected"; ?>>Tgl. Mutasi Masuk</option>
...
<option value="tgl_mutasi" <?php if ($kategori2=="tgl_mutasi") echo "selected"; ?>>Tgl. Mutasi Masuk</option>
...
<option value="masa_berlaku" <?php if ($kategori2=="masa_berlaku") echo "selected"; ?>>Masa Berlaku</option>
    ...
    <form name="input_key2" method="post" action="index.php?do=data.mutasi_masuk">
    				<td> 
                    <?php
                ...
                <tr>
                	<td colspan="5"><input type="button" value=" Cari " class="inputbox" onClick=" document.location.href='index.php?do=data.mutasi_masuk&kategori='+document.getElementById('kategori').value+'&key='+document.getElementById('key').value+'&kategori2='+document.getElementById('kategori2').value+'&key2='+document.getElementById('key2').value; "></td>
                </tr>
            </table>
        </fieldset>
    </td>
	<td width="8"></td>
	<td width="359" align="right" valign="bottom"><a href="excel_mutasi_masuk.php?do=data.apill&kategori=<?php echo $kategori; ?>&key=<?php echo $key; ?>&kategori2=<?php echo $kategori2; ?>&key2=<?php echo $key2; ?>&act=excel"><img src="images/excel.jpg" width="68" height="23" border="0"></a>&nbsp;&nbsp;<a href="index.php?do=data.mutasi_masuk&act=cetak&kategori=<?php echo $kategori; ?>&key=<?php echo $key; ?>&kategori2=<?php echo $kategori2; ?>&key2=<?php echo $key2; ?>"><img src="images/cetak.gif" title="Klik disini untuk Cetak Laporan" border="0"></a></td>
...
<table border="1" cellspacing="0" cellpadding="1" width="1360">
  <tr class="tdtitle_white">
    ...
    <td width="110" rowspan="2" background="images/bgcell.gif" height="25" align="center">Tgl. Mutasi Masuk </td>
  ...
  <tr class="text" bgcolor="<?php gantiwarna($NO); ?>">
    <td align="center" width="50"><a href="?do=data.mutasi_masuk&act=edit&id=<?php echo $row[id]; ?>"><img src="images/icon_edit.gif" border="0" title="Klik disini untuk Edit Data"></a></td>
    <td align="center" width="20"><a href="?do=data.mutasi_masuk&act=del&id=<?php echo $row[id]; ?>" onClick="return confirmdelete('Data ini');"><img src="images/icon_delete.gif" title="Klik disini untuk Hapus Data" border="0"></a></td>
