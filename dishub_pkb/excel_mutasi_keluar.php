...
<body>
<center>
<a class="tdtitle_black">Data Mutasi Keluar </a>
</center>
<br>
<table width="1310" border="1" align="center" cellpadding="1" cellspacing="0">
  <tr class="tdtitle_black">
    ...
    <td width="110" height="25" rowspan="2" align="center" bgcolor="#CCCCCC">Tgl. Mutasi Keluar </td>
  ...
  if(!empty($key) or !empty($key2)){
	  if(!empty($kategori)){
		  if(!empty($kategori2)){
			$strsql="select * from pkb_mutasi where status='0' and $kategori like '%$key%' and $kategori like '%$key2%' order by id desc";  
		  }else{
