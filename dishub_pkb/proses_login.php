...
$perintah="SELECT id,login,pwd,tipe,aktif FROM pkb_usermanager WHERE login='$username' AND pwd='$password' AND aktif='1'";
...
$passuser=$row[pwd];
$tipe=$row[tipe];
		$str_insert="UPDATE pkb_usermanager SET last_login='$sekarang' WHERE login='$username'";
