...
$strsql="INSERT INTO pkb_kendaraan_wajib_uji (nama, alamat, no_kend, no_uji, merk, type, jenis, model, kategori, cc, daya_motor, bahan_bakar, tahun_pembuatan, status_penggunaan, no_rangka, no_mesin, no_tgl_sertifik, uk_kend_panjang, uk_kend_lebar, uk_kend_tinggi, uk_kend_jalur_belakang, uk_kend_jalur_depan, jarak_sumbu_1_2, jarak_sumbu_2_3, jarak_sumbu_3_4, jarak_titik_berat, dim_bak_panjang, dim_bak_lebar, dim_bak_tinggi, dim_bak_bahan_bak, dim_tangki_panjang, dim_tangki_lebar, dim_tangki_tinggi, dim_tangki_volume, dim_tangki_jenis, dim_tangki_berat_jenis_muatan, dim_tangki_bahan_tangki, ban_sumbu_1, ban_sumbu_2, ban_sumbu_3, ban_sumbu_4, konfig_sumbu, jml_berat_diperbolehkan, jml_berat_kombinasi_diperbolehkan, berat_kosong_sumbu_1, berat_kosong_sumbu_2, berat_kosong_sumbu_3, berat_kosong_sumbu_4, daya_orang, daya_barang, jml_berat_diizinkan, jml_berat_kombinasi_diizinkan, muatan_sumbu_terberat, kelas_jalan, masa_berlaku_uji, tgl_entri) 
VALUES ('$nama','$alamat','$no_kend','$no_uji','$merk','$type','$jenis', '$model', '$kategori', '$cc','$daya_motor','$bahan_bakar','$tahun_pembuatan','$status_penggunaan','$no_rangka','$no_mesin','$no_tgl_sertifik','$uk_kend_panjang','$uk_kend_lebar','$uk_kend_tinggi','$uk_kend_jalur_belakang','$uk_kend_jalur_depan','$jarak_sumbu_1_2','$jarak_sumbu_2_3','$jarak_sumbu_3_4','$jarak_titik_berat','$dim_bak_panjang','$dim_bak_lebar','$dim_bak_tinggi','$dim_bak_bahan_bak','$dim_tangki_panjang','$dim_tangki_lebar','$dim_tangki_tinggi','$dim_tangki_volume','$dim_tangki_jenis','$dim_tangki_berat_jenis_muatan','$dim_tangki_bahan_tangki','$ban_sumbu_1','$ban_sumbu_2','$ban_sumbu_3','$ban_sumbu_4','$konfig_sumbu','$jml_berat_diperbolehkan','$jml_berat_kombinasi_diperbolehkan','$berat_kosong_sumbu_1','$berat_kosong_sumbu_2','$berat_kosong_sumbu_3','$berat_kosong_sumbu_4','$daya_orang','$daya_barang','$jml_berat_diizinkan','$jml_berat_kombinasi_diizinkan','$muatan_sumbu_terberat','$kelas_jalan','$masa_berlaku_uji','$sekarang')"; //echo $strsql;

if (empty($nama))
{
echo "<script>alert('nama Tidak Boleh Kosong'); document.location.href='index.php?act=add&do=data.kendaraan_wajib_uji&nama=$nama&alamat=$alamat&no_kend=$no_kend&no_uji=$no_uji;</script>\n";
exit();
}
else
{
