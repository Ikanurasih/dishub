...
$perintah="SELECT id,login,pwd,tipe,aktif FROM peg_usermanager WHERE login='$username' AND pwd='$password' AND aktif='1'";
...
$passuser=$row[pwd];
$tipe=$row[tipe];
		$str_insert="UPDATE peg_usermanager SET last_login='$sekarang' WHERE login='$username'";
