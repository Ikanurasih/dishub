...
<table border="0" cellpadding="0" cellspacing="1" width="100%">
  ...
  onClick="window.close();javascript:window.opener.document.forms[3].id_jalan.value='<?php echo $row[id]; ?>';
   window.close();javascript:window.opener.document.forms[3].nama_jalan.value='<?php echo $row[nama_jalan]; ?>';
   window.close();javascript:window.opener.document.forms[3].dari.value='<?php echo $row[dari]; ?>';
   window.close();javascript:window.opener.document.forms[3].ke.value='<?php echo $row[ke]; ?>'"> 
