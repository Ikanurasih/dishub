...
?>
<fieldset class="tdtitle_black">
<legend> Cetak Laporan Data Cermin Tikungan ke Microsoft Excel: </legend>
<table class="tdtitle_black">
<tr>
<td class="tdtitle_black" height="50" valign="middle"><?php include "excel_cermin.php"; ?></td>
</tr>
</table>
</fieldset>
<?php
...
<table width="890" border="0" cellpadding="2" cellspacing="2">
 ...
 // if ($_SESSION['tipe']=="2")
  ...
  <form method="post" action="index.php?do=data.cermin_tikungan">
	...
	&nbsp;&nbsp;</td>
	<td width="377"><div align="right"><a href="excel_cermin_tikungan.php?do=data.cermin_tikungan&kategori=<?php echo $kategori; ?>&key=<?php echo $key; ?>&act=excel"><img src="images/excel.jpg" width="68" height="23" border="0"></a>&nbsp;&nbsp;<a href="index.php?do=data.cermin_tikungan&act=cetak&kategori=<?php echo $kategori; ?>&key=<?php echo $key; ?>"><img src="images/cetak.gif" title="Klik disini untuk Cetak Laporan" border="0"></a></div></td>
	</form>
  </tr>
</table>
