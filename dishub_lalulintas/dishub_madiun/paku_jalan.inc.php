...
<table width="890" border="0" cellpadding="2" cellspacing="2">
  ...
  <form method="post" action="index.php?do=data.paku_jalan">
	...
	&nbsp;&nbsp;</td>
	<td width="458"><div align="right"><a href="index.php?do=data.paku_jalan&act=cetak&kategori=<?php echo $kategori; ?>&key=<?php echo $key; ?>"><img src="images/cetak.gif" title="Klik disini untuk Cetak Laporan" border="0"></a></div></td>
	</form>
  </tr>
</table>
