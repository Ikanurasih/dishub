...
<table width="821" border="0" cellpadding="2" cellspacing="2">
  ...
  <form method="post" action="index.php?do=data.peraturan">
	...
	&nbsp;&nbsp;</td>
	<td width="377"><div align="right"><a href="index.php?do=data.peraturan&act=cetak&kategori=<?php echo $kategori; ?>&key=<?php echo $key; ?>"><img src="images/cetak.gif" title="Klik disini untuk Cetak Laporan" border="0"></a></div></td>
	</form>
  </tr>
</table>
