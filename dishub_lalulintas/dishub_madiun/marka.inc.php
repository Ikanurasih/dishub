...
<table width="1300" border="0" cellpadding="2" cellspacing="2">
  ...
  <form method="post" action="index.php?do=data.marka">
	...
	&nbsp;&nbsp;</td>
	<td width="458" align="right"><a href="index.php?do=data.marka&act=cetak&kategori=<?php echo $kategori; ?>&key=<?php echo $key; ?>"><img src="images/cetak.gif" title="Klik disini untuk Cetak Laporan" border="0"></div></td>
	</form>
  </tr>
</table>
<table border="1" cellspacing="0" cellpadding="1" width="1300">
  ...
  <input type="hidden" name="id_jalan" value="<?php echo $id_jalan; ?>">
    ...
    <td height="25" align="center"><input type="text" name="nama_jalan" size="10" value="<?php echo $nama_jalan; ?>" class="inputbox" readonly=""> <input type="button" value="..." class="inputbox" onClick='Popreport_look_mtkopen("view_jalan.php")'></td>
