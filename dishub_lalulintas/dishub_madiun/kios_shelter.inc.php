...
<table width="990" border="0" cellpadding="2" cellspacing="2">
  ...
  ?>
  <tr>
    <td><a href="?act=add&do=data.kios_shelter"><img src="images/add.png" width="30" height="30" border="0" title="klik disini untuk Tambah Data Kios Shelter Baru"></a><a href="javascript:document.location.reload();"><img src="images/refresh.png" title="klik disini untuk Refresh" width="30" height="30" hspace="20" border="0"></a></td>
  </tr>
    <?php
  }
  ?>
  ...
  <form method="post" action="index.php?do=data.kios_shelter">
	...
	&nbsp;&nbsp;</td>
	<td width="377"><div align="right"><a href="index.php?do=data.kios_shelter&act=cetak&kategori=<?php echo $kategori; ?>&key=<?php echo $key; ?>"><img src="images/cetak.gif" title="Klik disini untuk Cetak Laporan" border="0"></a></div></td>
	</form>
  </tr>
</table>
