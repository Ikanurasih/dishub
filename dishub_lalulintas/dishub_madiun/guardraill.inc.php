...
<table width="500" cellspacing="0" cellpadding="0">
  <tr> 
    ...
    <td><strong><font color="#000000" size="4" face="Arial, Helvetica, sans-serif">Data Guardraill </font></strong></td>
  </tr>
</table>
<?php
if ($act=="cetak")
...
<legend> Cetak Laporan Data Guardraill: </legend>
<table class="tdtitle_black">
<form method="post" action="lap_guardraill.php" target="_blank">
...
<tr>
  <td colspan="3"><a href="index.php?do=data.guardraill"><img src="images/batal.gif" title="Klik disini untuk Batal" width="70" height="23" border="0"></a>&nbsp;&nbsp;
...
<table width="970" border="0" cellpadding="2" cellspacing="2">
  ...
  ?>
  <tr>
    <td><a href="?act=add&do=data.guardraill&id=<?php echo $id; ?>"><img src="images/add.png" width="30" height="30" border="0" title="klik disini untuk Tambah Data Guardraill Baru"></a><a href="javascript:document.location.reload();"><img src="images/refresh.png" title="klik disini untuk Refresh" width="30" height="30" hspace="20" border="0"></a></td>
  </tr>
  <?php
  }
  ?>
  <tr class="tdtitle_black">
  <form method="post" action="index.php?do=data.guardraill">
	...
	<option value="p_guardraill" <?php if ($kategori=="p_guardraill") echo "selected"; ?>>Panjang Guardraill</option>
	...
	&nbsp;&nbsp;</td>
	<td width="377"><div align="right"><a href="index.php?do=data.guardraill&act=cetak&kategori=<?php echo $kategori; ?>&key=<?php echo $key; ?>"><img src="images/cetak.gif" title="Klik disini untuk Cetak Laporan" border="0"></a></div></td>
	</form>
  </tr>
</table>
<table border="1" cellspacing="0" cellpadding="1" width="970">
  <tr class="tdtitle_white">
    ...
    <td width="130" background="images/bgcell.gif" height="25" align="center">Panjang Guadraill (m)</td>
  ...
  <form method="post" action="insert_guardraill.php">
    <input type="hidden" name="id_jalan" value="<?php echo $id_jalan; ?>">
    <td align="center" width="35"><a href="index.php?do=data.guardraill"><img src="images/kembali.png" title="Klik disini untuk Batal" border="0"></a></td>
    ...
    <td height="25" align="center"><input name="ke" type="text" class="inputbox" value="<?php echo $ke; ?>" size="20" readonly=""></td>
    <td height="25" align="center"><input type="text" name="p_guardraill" size="10" value="<?php echo $p_guardraill; ?>" class="inputbox"></td>
  ...
  ?>
  <tr class="text" bgcolor="efefef">
  <form method="post" action="update_guardraill.php">
...
<?php
  ...
  {
  ?>
    <td align="center" width="50"><a href="?do=data.guardraill&act=edit&id=<?php echo $row[id]; ?>"><img src="images/icon_edit.gif" border="0" title="Klik disini untuk Edit Data"></a></td>
    <td align="center" width="20"><a href="?do=data.guardraill&act=del&id=<?php echo $row[id]; ?>" onClick="return confirmdelete('Data ini');"><img src="images/icon_delete.gif" title="Klik disini untuk Hapus Data" border="0"></a></td>
 <?php
 }
 else
 {
