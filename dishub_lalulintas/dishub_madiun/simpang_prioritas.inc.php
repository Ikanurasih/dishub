...
?>
 ...
 ?>
  ...
  <form method="post" action="index.php?do=data.simpang_prioritas">
	...
	&nbsp;&nbsp;</td>
	<td width="458" align="right"><a href="index.php?do=data.simpang_prioritas&act=cetak&kategori=<?php echo $kategori; ?>&key=<?php echo $key; ?>"><img src="images/cetak.gif" title="Klik disini untuk Cetak Laporan" border="0"></a></td>
	</form>
  </tr>
</table>
