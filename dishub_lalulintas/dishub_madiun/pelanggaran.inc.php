...
<table width="1300" border="0" cellpadding="2" cellspacing="2">
  ...
  ?>  
  <tr>
    <td><a href="?act=add&do=data.pelanggaran"><img src="images/add.png" width="30" height="30" border="0" title="klik disini untuk Tambah Data Pelanggaran Baru"></a><a href="javascript:document.location.reload();"><img src="images/refresh.png" title="klik disini untuk Refresh" width="30" height="30" hspace="20" border="0"></a></td>
  </tr>
  <?php
  }
  ?>
  ...
  <form method="post" action="index.php?do=data.pelanggaran">
    <td>Pencarian: &nbsp;<select name="bulan" class="inputbox">
	...
	<input type="text" size="5" maxlength="4" name="tahun" value="<?php echo $tahun; ?>" class="inputbox"> &raquo; <font size="1.5">Enter</font>
	&nbsp;&nbsp;</td>
	<td width="377"><div align="right"><a href="index.php?do=data.pelanggaran&act=cetak&bulan=<?php echo $bulan; ?>&tahun=<?php echo $tahun; ?>"><img src="images/cetak.gif" title="Klik disini untuk Cetak Laporan" border="0"></a></div></td>
	</form>
  </tr>
</table>
