...
<table width="500" cellspacing="0" cellpadding="0">
  <tr> 
    ...
    <td><strong><font color="#000000" size="4" face="Arial, Helvetica, sans-serif">Data Patok Pengaman </font></strong></td>
  </tr>
</table>
<?php
if ($act=="cetak")
...
<legend> Cetak Laporan Data Patok Pengaman: </legend>
<table class="tdtitle_black">
<form method="post" action="lap_patok.php" target="_blank">
<tr>
...
<tr>
  <td colspan="3"><a href="index.php?do=data.patok_pengaman"><img src="images/batal.gif" title="Klik disini untuk Batal" width="70" height="23" border="0"></a>&nbsp;&nbsp;
...
<table width="890" border="0" cellpadding="2" cellspacing="2">
  ...
  <form method="post" action="index.php?do=data.patok_pengaman">
	...
	&nbsp;&nbsp;</td>
	<td width="377"><div align="right"><a href="excel_patok_pengaman.php?do=data.patok_pengaman&kategori=<?php echo $kategori; ?>&key=<?php echo $key; ?>&act=excel"><img src="images/excel.jpg" width="68" height="23" border="0"></a>&nbsp;&nbsp;<a href="index.php?do=data.patok_pengaman&act=cetak"><img src="images/cetak.gif" title="Klik disini untuk Cetak Laporan" border="0"></a></div></td>
	</form>
  </tr>
</table>
<table border="1" cellspacing="0" cellpadding="1" width="890">
  ...
  <form method="post" action="insert_patok.php" name="frmadd">
  <input type="hidden" name="id_jalan" value="<?php echo $id_jalan; ?>">
    <td align="center" width="35"><a href="index.php?do=data.patok_pengaman"><img src="images/kembali.png" title="Klik disini untuk Batal" border="0"></a></td>
  ...
  ?>
  <tr class="text" bgcolor="efefef">
  <form method="post" action="update_patok.php">
  ...
  {  $strsql="select a.*,b.dari, b.ke, b.nama_jalan from lal_umum a, lal_jalan b where a.id_jalan=b.id and b.nama_jalan like '%$key%' && tipe='3' order by id desc"; }
  elseif ($kategori=="dari")
  {  $strsql="select a.*,b.dari, b.ke, b.nama_jalan from lal_umum a, lal_jalan b where a.id_jalan=b.id and dari like '%$key%' && tipe='3' order by id desc"; }
  elseif ($kategori=="ke")
  {  $strsql="select a.*,b.dari, b.ke, b.nama_jalan from lal_umum a, lal_jalan b where a.id_jalan=b.id and ke like '%$key%' && tipe='3' order by id desc"; }
  elseif ($kategori=="jumlah")
  {  $strsql="select a.*,b.dari, b.ke, b.nama_jalan from lal_umum a, lal_jalan b where a.id_jalan=b.id and jumlah like '%$key%' && tipe='3' order by id desc"; }
  ...
  {  
	  ...
	  { $key="2";}
	  $strsql="select a.*,b.dari, b.ke, b.nama_jalan from lal_umum a, lal_jalan b where a.id_jalan=b.id and kondisi like '%$key%' && tipe='3' order by id desc"; }
  elseif ($kategori=="tahun")
  {  $strsql="select a.*,b.dari, b.ke, b.nama_jalan from lal_umum a, lal_jalan b where a.id_jalan=b.id and thn_pengadaan like '%$key%' && tipe='3' order by id desc"; }
  elseif ($kategori=="lokasi")
  {  $strsql="select a.*,b.dari, b.ke, b.nama_jalan from lal_umum a, lal_jalan b where a.id_jalan=b.id and lokasi like '%$key%' && tipe='3' order by id desc"; }  
  else
  {  $strsql="select a.*,b.dari, b.ke, b.nama_jalan from lal_umum a, lal_jalan b where a.id_jalan=b.id and tipe='3' order by id desc"; }
  $hasil=mysql_query($strsql);
  ...
  {
  ?>  
    <td align="center" width="50"><a href="?do=data.patok_pengaman&act=edit&id=<?php echo $row[id]; ?>"><img src="images/icon_edit.gif" border="0" title="Klik disini untuk Edit Data"></a></td>
    <td align="center" width="20"><a href="?do=data.patok_pengaman&act=del&id=<?php echo $row[id]; ?>" onClick="return confirmdelete('Data ini');"><img src="images/icon_delete.gif" title="Klik disini untuk Hapus Data" border="0"></a></td>
	    <?php
	}
	else
	{
