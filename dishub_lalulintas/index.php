...
<tr>
  ...
  <td width="83%" align="center">
	...
	<a href="index.php?do=data.marka" class="text_pasar">MARKA</a>
  	...
  	<a href="index.php?do=data.master_pangkal" class="text_pasar">MASTER RAMBU</a>
...
<tr>
  <td align="center">
	...
	<a href="index.php?do=data.perlengkapan" class="text_pasar">PERLENGKAPAN JALAN LAIN</a>
	<br><br>
	<?php
		$strsql="select * from lal_pangkal order by nama asc limit 0,1";
		$hasil=mysql_query($strsql);
		$row=mysql_fetch_array($hasil);	
	?> 
	<a href="index.php?do=data.rambu&id_pangkal=<?php echo $row[id]; ?>" class="text_pasar">RAMBU</a> 
	...
	<a href="index.php?do=data.zebra" class="text_pasar">ZEBRA CROSS</a>  
	<?php
	//if ($_SESSION['tipe']=="1")
	//{
	?>
...
elseif ($do=="data.perlengkapan")
{ include "perlengkapan.inc.php"; }
elseif ($do=="data.zebra")
{ include "zebra_cross.inc.php"; }
else
{ 
	if ($_SESSION['nameuser'])
	{
