...
<table width="500" cellspacing="0" cellpadding="0">
  <tr> 
    ...
    <td><strong><font color="#000000" size="4" face="Arial, Helvetica, sans-serif">Data Paku Jalan</font></strong></td>
  </tr>
</table>
<?php
if ($act=="cetak")
...
<legend> Cetak Laporan Data Paku Jalan: </legend>
<table class="tdtitle_black">
<form method="post" action="lap_paku.php" target="_blank">
...
<tr>
  <td colspan="3"><a href="index.php?do=data.paku_jalan"><img src="images/batal.gif" title="Klik disini untuk Batal" width="70" height="23" border="0"></a>&nbsp;&nbsp;
...
<table width="890" border="0" cellpadding="2" cellspacing="2">
  ...
  <form method="post" action="index.php?do=data.paku_jalan">
	...
	&nbsp;&nbsp;</td>
	<td width="458"><div align="right"><a href="excel_paku_jalan.php?do=data.apill&kategori=<?php echo $kategori; ?>&key=<?php echo $key; ?>&act=excel"><img src="images/excel.jpg" width="68" height="23" border="0"></a>&nbsp;&nbsp;<a href="index.php?do=data.paku_jalan&act=cetak&kategori=<?php echo $kategori; ?>&key=<?php echo $key; ?>"><img src="images/cetak.gif" title="Klik disini untuk Cetak Laporan" border="0"></a></div></td>
	</form>
  </tr>
</table>
<table border="1" cellspacing="0" cellpadding="1" width="890">
  ...
  <form method="post" action="insert_paku.php" name="frmadd">
  <input type="hidden" name="id_jalan" value="<?php echo $id_jalan; ?>">
    <td align="center" width="40"><a href="index.php?do=data.paku_jalan"><img src="images/kembali.png" title="Klik disini untuk Batal" border="0"></a></td>
  ...
  ?>
  <tr class="text" bgcolor="efefef">
  <form method="post" action="update_paku.php">
  <input type="hidden" name="id" value="<?php echo $id; ?>" />
  <input type="hidden" name="id_jalan" value="<?php echo $row[id_jalan]; ?>" />
    <td align="center" width="35"><a href="index.php?do=data.paku_jalan"><img src="images/kembali.png" title="Klik disini untuk Batal" border="0"></a></td>
    <td align="center" width="35"><input type="image" src="images/save.gif" title="Klik disini untuk Simpan"></td>
     <td height="25" align="center"><input type="text" name="nama_jalan" size="12" value="<?php echo $row[nama_jalan]; ?>" class="inputbox" readonly="">
       <input name="button" type="button" class="inputbox" onClick='Popreport_look_mtkopen("view_jalan.php")' value="..."></td>
  ...
  {
  ?>  
    <td align="center" width="50"><a href="?do=data.paku_jalan&act=edit&id=<?php echo $row[id]; ?>"><img src="images/icon_edit.gif" border="0" title="Klik disini untuk Edit Data"></a></td>
    <td align="center" width="20"><a href="?do=data.paku_jalan&act=del&id=<?php echo $row[id]; ?>" onClick="return confirmdelete('Data ini');"><img src="images/icon_delete.gif" title="Klik disini untuk Hapus Data" border="0"></a></td>
	    <?php
	}
	else
	{
