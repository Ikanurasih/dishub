...
?>
<fieldset class="tdtitle_black">
<legend> Cetak Laporan Data Juru Parkir ke Microsoft Excel: </legend>
<table class="tdtitle_black">
<tr>
<td class="tdtitle_black" height="50" valign="middle"><?php include "excel_jukir.php"; ?></td>
</tr>
</table>
</fieldset>
<?php
...
<table width="960" border="0" cellpadding="2" cellspacing="2">
  ...
  <form method="post" action="index.php?do=data.jukir">
	...
	&nbsp;&nbsp;</td>
	<td width="377"><div align="right"><a href="excel_jukir.php?do=data.jukir&kategori=<?php echo $kategori; ?>&key=<?php echo $key; ?>&act=excel" target="_blank"><img src="images/excel.jpg" width="68" height="23" border="0"></a>&nbsp;&nbsp;<a href="index.php?do=data.jukir&act=cetak&kategori=<?php echo $kategori; ?>&key=<?php echo $key; ?>"><img src="images/cetak.gif" title="Klik disini untuk Cetak Laporan" border="0"></a></div></td>
	</form>
  </tr>
</table>
<table border="1" cellspacing="0" cellpadding="1" width="960">
  <tr class="tdtitle_white">
    ...
    <td width="220" background="images/bgcell.gif" height="25" align="center">Alamat</td>       
    <td width="60" background="images/bgcell.gif" height="25" align="center">Jenis <br>Kelamin</td>       
    <td width="180" background="images/bgcell.gif" height="25" align="center">Titik Parkir</td>       
    <td width="180" background="images/bgcell.gif" height="25" align="center">Alamat Lokasi</td>       
  </tr>
  <?php
  if ($act=='add_jukir')
  {
  ...
  <form method="post" action="insert_jukir.php">
    ...
    <td height="25" align="center"><textarea name="alamat" class="inputbox" cols="33" rows="5"><?php echo $alamat; ?></textarea></td>
    ...
    <td height="25" align="center"><input type="text" name="titik_parkir" size="30" value="<?php echo $titik_parkir; ?>" class="inputbox"></td>
  ...
  <input type="hidden" name="id" value="<?php echo $id; ?>">
    ...
    <td height="25" align="center"><textarea name="alamat" class="inputbox" cols="33" rows="5"><?php echo $row[alamat]; ?></textarea></td>
    <td height="25" align="center">
	<select name="jk" class="inputbox2">
    ...
    <td height="25" align="center"><input type="text" name="titik_parkir" size="30" value="<?php echo $row[titik_parkir]; ?>" class="inputbox"></td>
