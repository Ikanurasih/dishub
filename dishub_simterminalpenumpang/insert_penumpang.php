...
$strsql="insert into ter_penumpang(
tanggal, 
bus_nganjuk, rit_nganjuk, pnp_nganjuk, pnp_peron_nganjuk, nilai_peron_nganjuk, hasil_peron_nganjuk,
bus_ponorogo, rit_ponorogo, pnp_ponorogo, pnp_peron_ponorogo, nilai_peron_ponorogo, hasil_peron_ponorogo,
bus_magetan, rit_magetan, pnp_magetan, pnp_peron_magetan, nilai_peron_magetan, hasil_peron_magetan,
bus_lainnya, rit_lainnya, pnp_lainnya, pnp_peron_lainnya, nilai_peron_lainnya, hasil_peron_lainnya
)
values
(
'$tanggal', 
...
if (empty($tanggal))
{
echo "<script>alert('Tanggal Tidak Boleh Kosong'); document.location.href='index.php?act=add&do=data.penumpang
&tanggal=$tanggal
