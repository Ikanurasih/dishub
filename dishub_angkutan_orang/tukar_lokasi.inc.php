...
if ($act=="del")
{
mysql_query("delete from ang_tukar_lokasi where id='$id'");
}
?>
...
<table width="500" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td><strong><font color="#000000" size="4" face="Arial, Helvetica, sans-serif">Data Tukar Lokasi Wilayah Operasi </font></strong></td>
  </tr>
</table>
<?php
if ($act=="cetak")
...
<legend> Cetak Laporan Data Tukar Lokasi Wilayah Operasi: </legend>
<table class="tdtitle_black">
<form method="post" action="lap_tukar_lokasi.php" target="_blank">
...
<tr>
  <td colspan="3"><a href="index.php?do=data.tukar_lokasi"><img src="images/batal.gif" title="Klik disini untuk Batal" width="70" height="23" border="0"></a>&nbsp;&nbsp;
...
<table width="1350" border="0" cellpadding="2" cellspacing="2">
  <tr>
    <td><a href="?act=add&do=data.tukar_lokasi"><img src="images/add.png" width="30" height="30" border="0" title="klik disini untuk Tukar Lokasi Wilayah Operasi"></a><a href="javascript:document.location.reload();"><img src="images/refresh.png" title="klik disini untuk Refresh" width="30" height="30" hspace="20" border="0"></a></td>
  </tr>
  <tr class="tdtitle_black">
  <form method="post" action="index.php?do=data.tukar_lokasi">
    <td>Pencarian: &nbsp;<select name="kategori" class="inputbox">
	<option value="trayek_lama" <?php if ($kategori=="trayek_lama") echo "selected"; ?>>Trayek Lama</option>
	<option value="trayek_baru" <?php if ($kategori=="trayek_baru") echo "selected"; ?>>Trayek Baru</option>

	</select>
	<input type="text" name="key" value="<?php echo $key; ?>" class="inputbox"> &raquo; <font size="1.5">Enter</font>
	&nbsp;&nbsp;</td>
	<td width="377"><div align="right"><a href="index.php?do=data.tukar_lokasi&act=cetak&kategori=<?php echo $kategori; ?>&key=<?php echo $key; ?>"><img src="images/cetak.gif" title="Klik disini untuk Cetak Laporan" border="0"></a></div></td>
	</form>
  </tr>
 </table>
 <table border="1" cellspacing="0" cellpadding="1" width="1350">
  <tr class="tdtitle_white">
    ...
    <td colspan="2" background="images/bgcell.gif" height="25" align="center">Kode<br>Trayek</td>              
    ...
    <td colspan="2" width="100" background="images/bgcell.gif" height="25" align="center">Trayek<br>Operasi</td>                           
    <td rowspan="2" width="100" background="images/bgcell.gif" height="25" align="center">Tahun<br>Tukar</td>                           
  ...
  <tr class="tdtitle_white">
	...
	<td width="60" background="images/bgcell.gif" height="25" align="center">Lama</td>              
    <td width="60" background="images/bgcell.gif" height="25" align="center">Baru</td>
	<td width="60" background="images/bgcell.gif" height="25" align="center">Lama</td>              
    <td width="60" background="images/bgcell.gif" height="25" align="center">Baru</td>
  </tr>
   <?php
  ...
  {
  ?>
  <form method="post" action="insert_tukar_lokasi.php" >
  <tr class="text" bgcolor="efefef">
  <input type="hidden" name="id_kendaraan_bermotor_umum" value="<?php echo $id_kendaraan_bermotor_umum; ?>">
    <td align="center" width="35"><a href="index.php?do=data.tukar_lokasi"><img src="images/kembali.png" title="Klik disini untuk Batal" border="0"></a></td>
    <td align="center" width="35"><input type="image" src="images/save.gif" title="Klik disini untuk Simpan"></td>
    <td height="25" align="center"><input type="text" name="nama" size="7" value="<?php echo $nama; ?>" class="inputbox" readonly />
    <input type="button" value="..." class="inputbox" onClick='Popreport_look_mtkopen_kend_umum("view_kendaraan_bermotor_umum2.php")'></td>
    <!--<td height="25" align="center"><input type="text" name="alamat" size="20" value="<?php echo $alamat; ?>" class="inputbox" readonly /></td>-->
	...
	<td height="25" align="center"><input type="text" name="kode_trayek_lama" size="5" value="<?php echo $kode_trayek_lama; ?>" class="inputbox"  /></td>
	<td height="25" align="center"><input type="text" name="kode_trayek_baru" size="5" value="<?php echo $kode_trayek_baru; ?>" class="inputbox"  /></td>
	<td height="25" align="center"><input type="hidden" name="kode_trayek" size="8" value="<?php echo $kode_trayek; ?>" class="inputbox" readonly /><input type="text" name="status_trayek" size="5" value="<?php echo $status_trayek; ?>" class="inputbox" readonly /></td>
	...
	<td height="25" align="center"><input type="text" name="trayek_lama" size="7" value="<?php echo $trayek_lama; ?>" class="inputbox"  /></td>
	<td height="25" align="center"><input type="text" name="trayek_baru" size="7" value="<?php echo $trayek_baru; ?>" class="inputbox"  /></td>
	
	<td height="25" align="center"><input type="text" name="tahun_tukar_lokasi" size="3" maxlength="4" value="<?php echo $tahun_tukar_lokasi; ?>" class="inputbox" /></td>
  </tr>
	</form>
   <?php
  }
  elseif($act=="edit")
  {
  $strsql="select a.id_kendaraan_bermotor_umum, a.id as id_tukar, a.kode_trayek_lama, a.kode_trayek_baru, a.trayek_lama, a.trayek_baru, a.tahun_tukar_lokasi, b.*, c.*, d.*, e.* from ang_tukar_lokasi a, ang_kendaraan_bermotor_umum b, ang_master_pemilik c, ang_master_kendaraan d, ang_master_trayek e where a.id_kendaraan_bermotor_umum=b.id && b.id_pemilik=c.id && b.id_kendaraan=d.id && b.id_trayek=e.id && a.id='$id' order by a.id desc";
  $hasil=mysql_query($strsql);
  $row=mysql_fetch_array($hasil);  
  ?>
  <form method="post" action="update_tukar_lokasi.php">
  <tr class="text" bgcolor="efefef">
  <input type="hidden" name="id" value="<?php echo $id; ?>">
  <input type="hidden" name="id_kendaraan_bermotor_umum" value="<?php echo $row[id_kendaraan_bermotor_umum]; ?>">
    <td align="center" width="35"><a href="index.php?do=data.tukar_lokasi"><img src="images/kembali.png" title="Klik disini untuk Batal" border="0"></a></td>
    <td align="center" width="35"><input type="image" src="images/save.gif" title="Klik disini untuk Simpan"></td>
     <td height="25" align="center"><input type="text" name="nama" size="7" value="<?php echo $row[nama]; ?>" class="inputbox" readonly />
     <input type="button" value="..." class="inputbox" onClick='Popreport_look_mtkopen_kend_umum("view_kendaraan_bermotor_umum2.php")'></td>
    <!--<td height="25" align="center"><input type="text" name="alamat" size="20" value="<?php echo $row[alamat]; ?>" class="inputbox" readonly /></td>-->
	...
	<td height="25" align="center"><input type="text" name="kode_trayek_lama" size="5" value="<?php echo $row[kode_trayek_lama]; ?>" class="inputbox"  /></td>
	<td height="25" align="center"><input type="text" name="kode_trayek_baru" size="5" value="<?php echo $row[kode_trayek_baru]; ?>" class="inputbox"  /></td>
	<td height="25" align="center"><input type="text" name="status_trayek" size="5" value="<?php echo $row[status_trayek]; ?>" class="inputbox" readonly /></td>
	<td height="25" align="center"><input type="text" name="jadwal_perjalanan" size="7" value="<?php echo $row[jadwal_perjalanan]; ?>" class="inputbox" readonly /></td>
		<td height="25" align="center"><input type="text" name="trayek_lama" size="7" value="<?php echo $row[trayek_lama]; ?>" class="inputbox"  /></td>
	<td height="25" align="center"><input type="text" name="trayek_baru" size="7" value="<?php echo $row[trayek_baru]; ?>" class="inputbox"  /></td>
	<td height="25" align="center"><input type="text" name="tahun_tukar_lokasi" size="5" maxlength='4' value="<?php echo $row[tahun_tukar_lokasi]; ?>" class="inputbox"/></td>
  </tr>
	</form>
  <?php
    }
  ...
  <tr class="text" bgcolor="<?php gantiwarna($NO); ?>">
    <td align="center" width="50"><a href="?do=data.tukar_lokasi&act=edit&id=<?php echo $row[id_tukar]; ?>"><img src="images/icon_edit.gif" border="0" title="Klik disini untuk Edit Data"></a></td>
    <td align="center" width="20"><a href="?do=data.tukar_lokasi&act=del&id=<?php echo $row[id_tukar]; ?>" onClick="return confirmdelete('Data ini');"><img src="images/icon_delete.gif" title="Klik disini untuk Hapus Data" border="0"></a></td>
