...
if ($act=='set')
{
$strsql="select id,aktif from ang_usermanager where id='$id'";
$hasil=mysql_query($strsql);
$row=mysql_fetch_array($hasil);

	if ($row[aktif]=='1')
	{
	mysql_query("update ang_usermanager set aktif='0' where id='$id' and aktif='1'");
	}
	else
	{
	mysql_query("update ang_usermanager set aktif='1' where id='$id' and aktif='0'");
	}
}

if ($act=='del')
{
mysql_query("delete from ang_usermanager where id='$id'");
}
?>
<html>
<head>
...
<table border="1" cellpadding="1" cellspacing="0">
  ...
  elseif ($act=="edit")
  {
  $strsql="select * from ang_usermanager where id='$id'";
  $hasil=mysql_query($strsql);
  $row=mysql_fetch_array($hasil);  
  ?>
  <tr class="text" bgcolor="efefef">
  ...
  <?php
	...
	$strsql="select id,login,pwd,tipe,aktif,last_login from ang_usermanager order by id desc";
	$hasil=mysql_query($strsql);
