...
if ($act=="del")
{
mysql_query("delete from ang_izin_trayek where id='$id'");
}
?>
...
<table width="500" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td><strong><font color="#000000" size="4" face="Arial, Helvetica, sans-serif">Data Pelayanan Izin Trayek </font></strong></td>
  </tr>
</table>
<?php
if ($act=="cetak")
...
<legend> Cetak Laporan Data Pelayanan Izin Trayek: </legend>
<table class="tdtitle_black">
<form method="post" action="lap_izin_trayek.php" target="_blank">
...
<tr>
  <td colspan="3"><a href="index.php?do=data.izin_trayek"><img src="images/batal.gif" title="Klik disini untuk Batal" width="70" height="23" border="0"></a>&nbsp;&nbsp;
...
<table width="1350" border="0" cellpadding="2" cellspacing="2">
  <tr>
    <td><a href="?act=add&do=data.izin_trayek"><img src="images/add.png" width="30" height="30" border="0" title="klik disini untuk Tambah Data Pelayanan Izin Trayek Baru"></a><a href="javascript:document.location.reload();"><img src="images/refresh.png" title="klik disini untuk Refresh" width="30" height="30" hspace="20" border="0"></a></td>
  </tr>
  <tr class="tdtitle_black">
  <form method="post" action="index.php?do=data.izin_trayek">
    <td>Pencarian: &nbsp;<select name="kategori" class="inputbox">
	<!--<option value="masa_trayek" <?php if ($kategori=="masa_trayek") echo "selected"; ?>>Masa Trayek</option>-->
	<option value="no_izin_trayek" <?php if ($kategori=="no_izin_trayek") echo "selected"; ?>>No. Izin Trayek</option>
	<!--<option value="no_izin_trayek" <?php if ($kategori=="no_izin_trayek") echo "selected"; ?>>Tgl. Izin Trayek</option>-->

	</select>
	<input type="text" name="key" value="<?php echo $key; ?>" class="inputbox"> &raquo; <font size="1.5">Enter</font>
	&nbsp;&nbsp;</td>
	<td width="377"><div align="right"><a href="index.php?do=data.izin_trayek&act=cetak&kategori=<?php echo $kategori; ?>&key=<?php echo $key; ?>"><img src="images/cetak.gif" title="Klik disini untuk Cetak Laporan" border="0"></a></div></td>
	</form>
  </tr>
</table>
 <table border="1" cellspacing="0" cellpadding="1" width="1350">
  <tr class="tdtitle_white">
    ...
    <td rowspan="2" width="120" background="images/bgcell.gif" height="25" align="center">Kode Trayek </td>              
    <td rowspan="2" width="100" background="images/bgcell.gif" height="25" align="center">Masa Berlaku<br>
Izin Trayek </td>           
    <td rowspan="2" width="100" background="images/bgcell.gif" height="25" align="center">No. Izin<br>Trayek</td>              
    <td rowspan="2" width="100" background="images/bgcell.gif" height="25" align="center">Tgl. Izin<br>Trayek</td>                       
  </tr>
  <tr class="tdtitle_white">
  ...
  {
  ?>
  <form method="post" action="insert_izin_trayek.php" >
  <tr class="text" bgcolor="efefef">
  <input type="hidden" name="id_kendaraan_bermotor_umum" value="<?php echo $id_kendaraan_bermotor_umum; ?>">
    <td align="center" width="35"><a href="index.php?do=data.izin_trayek"><img src="images/kembali.png" title="Klik disini untuk Batal" border="0"></a></td>
	...
	<td height="25" align="center"><input type="text" name="kode_trayek" size="7" value="<?php echo $kode_trayek; ?>" class="inputbox" readonly /><input type="hidden" name="status_trayek" size="10" value="<?php echo $status_trayek; ?>" class="inputbox" readonly /><input type="hidden" name="jadwal_perjalanan" size="10" value="<?php echo $jadwal_perjalanan; ?>" class="inputbox" readonly /><input type="hidden" name="wilayah_opr" size="10" value="<?php echo $wilayah_opr; ?>" class="inputbox" readonly /></td>
	<td height="25" align="center"><input type="text" id="masa_trayek" name="masa_trayek" size="10" value="<?php echo $masa_trayek; ?>" class="inputbox" readonly /><img src="popupcal/images/calendar.gif" width="24" height="12" onClick="displayCalendar(document.getElementById('masa_trayek'),'yyyy-mm-dd',this)" style="cursor:pointer" /></td>
	<td height="25" align="center"><input type="text" name="no_izin_trayek" size="7" value="<?php echo $no_izin_trayek; ?>" class="inputbox"/></td>
	<td height="25" align="center"><input type="text" id="tgl_izin_trayek" name="tgl_izin_trayek" size="10" value="<?php echo $tgl_izin_trayek; ?>" class="inputbox" readonly /><img src="popupcal/images/calendar.gif" width="24" height="12" onClick="displayCalendar(document.getElementById('tgl_izin_trayek'),'yyyy-mm-dd',this)" style="cursor:pointer" /></td>
  </tr>
	</form>
   <?php
  }
  ...
  <input type="hidden" name="id_kendaraan_bermotor_umum" value="<?php echo $row[id_kendaraan_bermotor_umum]; ?>">
	...
	<td height="25" align="center"><input type="text" name="kode_trayek" size="7" value="<?php echo $row[kode_trayek]; ?>" class="inputbox" readonly /><input type="hidden" name="status_trayek" size="10" value="<?php echo $row[status_trayek]; ?>" class="inputbox" readonly /><input type="hidden" name="jadwal_perjalanan" size="10" value="<?php echo $row[jadwal_perjalanan]; ?>" class="inputbox" readonly /><input type="hidden" name="wilayah_opr" size="10" value="<?php echo $row[wilayah_opr]; ?>" class="inputbox" readonly /></td>
	<td height="25" align="center"><input type="text" id="masa_trayek" name="masa_trayek" size="10" value="<?php echo $row[masa_trayek]; ?>" class="inputbox" readonly /><img src="popupcal/images/calendar.gif" width="24" height="12" onClick="displayCalendar(document.getElementById('masa_trayek'),'yyyy-mm-dd',this)" style="cursor:pointer" /></td>
	<td height="25" align="center"><input type="text" name="no_izin_trayek" size="7" value="<?php echo $row[no_izin_trayek]; ?>" class="inputbox"/></td>
	<td height="25" align="center"><input type="text" id="tgl_izin_trayek" name="tgl_izin_trayek" size="10" value="<?php echo $row[tgl_izin_trayek]; ?>" class="inputbox" readonly /><img src="popupcal/images/calendar.gif" width="24" height="12" onClick="displayCalendar(document.getElementById('tgl_izin_trayek'),'yyyy-mm-dd',this)" style="cursor:pointer" /></td>
  </tr>
	</form>
  <?php
    }
  ...
  <tr class="text" bgcolor="<?php gantiwarna($NO); ?>">
    <td align="center" width="50"><a href="?do=data.izin_trayek&act=edit&id=<?php echo $row[id_izin_trayek]; ?>"><img src="images/icon_edit.gif" border="0" title="Klik disini untuk Edit Data"></a></td>
    <td align="center" width="20"><a href="?do=data.izin_trayek&act=del&id=<?php echo $row[id_izin_trayek]; ?>" onClick="return confirmdelete('Data ini');"><img src="images/icon_delete.gif" title="Klik disini untuk Hapus Data" border="0"></a></td>
