...
if ($act=="del")
{
mysql_query("delete from ang_pengurangan_kendaraan where id='$id'");
}
?>
...
<table width="500" cellspacing="0" cellpadding="0">
  <tr>
    <td width="59"><div align="left"><img src="images/arrow_down_48.png" width="48" height="48" hspace="5" vspace="5"></div></td>
    <td><strong><font color="#000000" size="4" face="Arial, Helvetica, sans-serif">Data Pengurangan Kendaraan / Trayek </font></strong></td>
  </tr>
</table>
<?php
if ($act=="cetak")
...
<legend> Cetak Laporan Data Pengurangan Kendaraan: </legend>
<table class="tdtitle_black">
<form method="post" action="lap_pengurangan.php" target="_blank">
...
<tr>
  <td colspan="3"><a href="index.php?do=data.pengurangan"><img src="images/batal.gif" title="Klik disini untuk Batal" width="70" height="23" border="0"></a>&nbsp;&nbsp;
...
<table width="1350" border="0" cellpadding="2" cellspacing="2">
  <tr>
    <td><a href="?act=add&do=data.pengurangan"><img src="images/add.png" width="30" height="30" border="0" title="klik disini untuk Tambah Data Pengurangan Kendaraan"></a><a href="javascript:document.location.reload();"><img src="images/refresh.png" title="klik disini untuk Refresh" width="30" height="30" hspace="20" border="0"></a></td>
  </tr>
  <tr class="tdtitle_black">
  <form method="post" action="index.php?do=data.pengurangan">
	...
	&nbsp;&nbsp;</td>
	<td width="377"><div align="right"><a href="index.php?do=data.pengurangan&act=cetak&kategori=<?php echo $kategori; ?>&key=<?php echo $key; ?>"><img src="images/cetak.gif" title="Klik disini untuk Cetak Laporan" border="0"></a></div></td>
	</form>
  </tr>
 </table>
 <table border="1" cellspacing="0" cellpadding="1" width="1350">
  <tr class="tdtitle_white">
    ...
    <td rowspan="2" width="100" background="images/bgcell.gif" height="25" align="center">Tahun<br>Pengurangan</td>                           
  </tr>
  <tr class="tdtitle_white">
  ...
  {
  ?>
  <form method="post" action="insert_pengurangan.php" name="frmadd">
  <tr class="text" bgcolor="efefef">
  <input type="hidden" name="id_kendaraan_bermotor_umum" value="<?php echo $id_kendaraan_bermotor_umum; ?>">
    <td align="center" width="35"><a href="index.php?do=data.pengurangan"><img src="images/kembali.png" title="Klik disini untuk Batal" border="0"></a></td>
	...
	<td height="25" align="center"><input type="text" name="tahun" size="5" maxlength="4" value="<?php echo $tahun; ?>" class="inputbox" readonly /></td>
	...
	<td height="25" align="center"><input type="text" name="kode_trayek" size="5" value="<?php echo $kode_trayek; ?>" class="inputbox" readonly /></td>
	<td height="25" align="center"><input type="text" name="status_trayek" size="5" value="<?php echo $status_trayek; ?>" class="inputbox" readonly /></td>
	...
	<td height="25" align="center"><input type="text" name="tahun_pengurangan" size="5" maxlength="4" value="<?php echo $tahun_pengurangan; ?>" class="inputbox" /></td>
  </tr>
	</form>
   <?php
  }
  elseif($act=="edit")
  {
  $strsql="select a.id_kendaraan_bermotor_umum, a.id as id_kurang, tahun_pengurangan, b.*, c.*, d.*, e.* from ang_pengurangan_kendaraan a, ang_kendaraan_bermotor_umum b, ang_master_pemilik c, ang_master_kendaraan d, ang_master_trayek e where a.id_kendaraan_bermotor_umum=b.id && b.id_pemilik=c.id && b.id_kendaraan=d.id && b.id_trayek=e.id && a.id='$id' order by a.id desc";
  $hasil=mysql_query($strsql);
  $row=mysql_fetch_array($hasil);  
  ?>
  <form method="post" action="update_pengurangan.php">
  <tr class="text" bgcolor="efefef">
  ...
  <input type="hidden" name="id_kendaraan_bermotor_umum" value="<?php echo $row[id_kendaraan_bermotor_umum]; ?>">
	...
	<td height="25" align="center"><input type="text" name="tahun" size="5" maxlength="4" value="<?php echo $row[tahun]; ?>" class="inputbox" readonly /></td>
	...
	<td height="25" align="center"><input type="text" name="kode_trayek" size="5" value="<?php echo $row[kode_trayek]; ?>" class="inputbox" readonly /></td>
	...
	<td height="25" align="center"><input type="text" name="tahun_pengurangan" size="5" maxlength='4' value="<?php echo $row[tahun_pengurangan]; ?>" class="inputbox"/></td>
  </tr>
	</form>
  <?php
    }
  if ($kategori=="nama")
  {  $strsql="select a.*, b.*, c.*, d.*, e.* from ang_pengurangan_kendaraan a, ang_kendaraan_bermotor_umum b, ang_master_pemilik c, ang_master_kendaraan d, ang_master_trayek e where a.id_kendaraan_bermotor_umum=b.id && b.id_pemilik=c.id && b.id_kendaraan=d.id && b.id_trayek=e.id && c.nama like '%$key%' order by a.id desc"; }
  elseif ($kategori=="no_kend")
  {  $strsql="select a.*, b.*, c.*, d.*, e.* from ang_pengurangan_kendaraan a, ang_kendaraan_bermotor_umum b, ang_master_pemilik c, ang_master_kendaraan d, ang_master_trayek e where a.id_kendaraan_bermotor_umum=b.id && b.id_pemilik=c.id && b.id_kendaraan=d.id && b.id_trayek=e.id && d.no_kend like '%$key%' order by a.id desc"; }
   elseif ($kategori=="wilayah_opr")
  {  $strsql="select a.*, b.*, c.*, d.*, e.* from ang_pengurangan_kendaraan a, ang_kendaraan_bermotor_umum b, ang_master_pemilik c, ang_master_kendaraan d, ang_master_trayek e where a.id_kendaraan_bermotor_umum=b.id && b.id_pemilik=c.id && b.id_kendaraan=d.id && b.id_trayek=e.id && e.wilayah_opr like '%$key%' order by a.id desc"; }
  else
  {  $strsql="select a.id as id_kurang, a.tahun_pengurangan, b.*, c.*, d.*, e.* from ang_pengurangan_kendaraan a, ang_kendaraan_bermotor_umum b, ang_master_pemilik c, ang_master_kendaraan d, ang_master_trayek e where a.id_kendaraan_bermotor_umum=b.id && b.id_pemilik=c.id && b.id_kendaraan=d.id && b.id_trayek=e.id order by a.id desc"; }
  $hasil=mysql_query($strsql);
  ...
  <tr class="text" bgcolor="<?php gantiwarna($NO); ?>">
    <td align="center" width="50"><a href="?do=data.pengurangan&act=edit&id=<?php echo $row[id_kurang]; ?>"><img src="images/icon_edit.gif" border="0" title="Klik disini untuk Edit Data"></a></td>
    <td align="center" width="20"><a href="?do=data.pengurangan&act=del&id=<?php echo $row[id_kurang]; ?>" onClick="return confirmdelete('Data ini');"><img src="images/icon_delete.gif" title="Klik disini untuk Hapus Data" border="0"></a></td>
    ...
    <td height="25" align="center"><?php echo $row[tahun_pengurangan]; ?></td>
  </tr>
  <?php
  }
  ?>
