...
$strsql="INSERT INTO ang_penambahan_kendaraan (id_kendaraan_bermotor_umum,tahun_penambahan,tgl_entri) 
VALUES ('$id_kendaraan_bermotor_umum','$tahun_penambahan','$sekarang')"; //echo $strsql;

if (empty($tahun_penambahan))
{
echo "<script>alert('Tahun Penambahan Tidak Boleh Kosong'); document.location.href='index.php?act=add&do=data.penambahan&id_kendaraan_bermotor_umum=$id_kendaraan_bermotor_umum&nama=$nama&alamat=$alamat&no_kend=$no_kend&no_uji=$no_uji&merk=$merk&jenis_kend=$jenis_kend&cc=$cc&bahan_bakar=$bahan_bakar&tahun=$tahun&no_rangka=$no_rangka&no_mesin=$no_mesin&daya_orang=$daya_orang&daya_barang=$daya_barang&jenis_angkutan=$jenis_angkutan&jenis_trayek=$jenis_trayek&jenis_pelayanan=$jenis_pelayanan&kode_trayek=$kode_trayek&status_trayek=$status_trayek&jadwal_perjalanan=$jadwal_perjalanan&wilayah_opr=$wilayah_opr&tahun_penambahan=$tahun_penambahan';</script>\n";
exit();
}
